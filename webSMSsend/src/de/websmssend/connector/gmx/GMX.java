...
package de.websmssend.connector.gmx;

import de.websmssend.connector.base.CP1252Coder;
    ...
    public void checkSmsSenderNameCharacters(String text) throws Exception {
        ...
        for (int i = 0; i < checkname.length; i++) {
            if ((checkname[i] >= 'a' && checkname[i] <= 'z') ||
                ...
                throw new Exception("Nur Buchstaben (keine Umlaute) und Leerzeichen sind erlaubt!");
            }
        }
    }
